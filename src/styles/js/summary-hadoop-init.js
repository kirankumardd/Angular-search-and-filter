  ...
  //for Avg. Network bytes : avg_net_canvas
              ...
              avgContainerUptimeBar.animate(0.40); // Number from 0.0 to 1.0
              ...
              spotContainerPerBar.animate(0.30); // Number from 0.0 to 1.0
